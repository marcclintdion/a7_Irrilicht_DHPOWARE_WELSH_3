    ...
    //------------------------------------------------------------------------------------------------------------------------------------    
    Translate(modelView, facing_UP_POSITION[0] + 2.0, facing_UP_POSITION[1], facing_UP_POSITION[2]);                                                                                         
    Rotate(modelView, facing_UP_ROTATE[0], facing_UP_ROTATE[1], facing_UP_ROTATE[2], facing_UP_ROTATE[3] + rotateModel *2);                                                                      
    Rotate(modelView, 0.0, 1.0, 0.0, rotateModelWithLeftMouse[1]);    
    Rotate(modelView, 1.0, 0.0, 0.0, rotateModelWithLeftMouse[0]);
